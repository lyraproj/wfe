module github.com/puppetlabs/go-fsm
...
require (
	...
	github.com/puppetlabs/go-hiera v0.0.0-20181127072836-0bdfef77748d
	...
	github.com/puppetlabs/go-puppet-dsl-workflow v0.0.0-20181127221109-bc20d8cdc39b
